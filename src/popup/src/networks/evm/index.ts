...
export const networks :{[network: string]: IEVMNetwork} = {
  [EVMNetwork.LOCALHOST]: {
    ...
    nativeCurreny: EVMAssetId.ETHEREUM_ETH,
  },
  [EVMNetwork.ETHEREUM]: {
    chainId: 1,
  ...
  [EVMNetwork.ETHEREUM_TESTNET_GOERLI]: {
    ...
    nativeCurreny: EVMAssetId.ETHEREUM_TESTNET_GOERLI_ETH,
  },
  [EVMNetwork.AVALANCHE_TESTNET_FUJI]: {
    ...
    nativeCurreny: EVMAssetId.AVALANCHE_TESTNET_FUJI_AVAX,
  },
};
